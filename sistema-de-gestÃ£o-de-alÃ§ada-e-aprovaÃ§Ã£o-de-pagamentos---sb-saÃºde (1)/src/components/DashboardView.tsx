      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm flex flex-col justify-between">
          ...
          <div className="text-[10px] text-emerald-600 font-semibold mt-2 flex items-center gap-1">
            ...
            <span>+{kpis.proximasVencimento || 3} vencendo em 5d úteis</span>
          </div>
        </div>
        ...
        <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm flex flex-col justify-between">
          <div>
            ...
            <div className="text-2xl font-bold text-slate-800">
              {formatCurrency(kpis.valorTotalEmAprovacao || 412502)}
            </div>
          </div>
        ...
        <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm flex flex-col justify-between">
          <div>
            ...
            <div className="text-2xl font-bold text-emerald-600">
              {formatCurrency(kpis.valorTotalPago || 389420)}
            </div>
          </div>
          <div className="mt-2">
            ...
            <div className="h-1.5 w-full bg-slate-100 rounded-full overflow-hidden">
              <div className="h-full w-[74%] bg-blue-600 rounded-full"></div>
            </div>
          </div>
        </div>
        ...
        <aside className="flex flex-col gap-6">
          ...
          <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2.5">
              <button
                onClick={() => onNavigateTab('NOVA_SOLICITACAO')}
                className="w-full bg-blue-600 text-white py-2.5 rounded-lg text-xs font-bold shadow-sm shadow-blue-200 hover:bg-blue-700 active:scale-95 transition-all flex items-center justify-center gap-2"
              >
                <Plus className="w-4 h-4" />
                <span>Nova Solicitação FOR-FIN-01</span>
              </button>
              <button
                onClick={() => onNavigateTab('MINHA_FILA')}
                className="w-full bg-white border border-slate-200 text-slate-700 py-2.5 rounded-lg text-xs font-bold hover:bg-slate-50 transition-colors flex items-center justify-center gap-2"
              >
                <span>Acessar Minha Fila de Trabalho</span>
              </button>
            </div>
          </div>
          ...
          <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm flex flex-col">
            ...
            <div className="flex flex-col gap-4">
              <div className="space-y-1">
                ...
                <div className="text-[10px] text-slate-400">R$ 440k / R$ 500k</div>
              </div>
              ...
              <div className="space-y-1">
                ...
                <div className="h-2 w-full bg-slate-100 rounded-full overflow-hidden">
                  <div className="h-full w-[42%] bg-blue-600 rounded-full"></div>
                </div>
                <div className="text-[10px] text-slate-400">R$ 8.4k / R$ 20k</div>
              </div>
              ...
              <div className="space-y-1">
                ...
                <div className="text-[10px] text-slate-400">R$ 3.1k / R$ 20k</div>
              </div>
          ...
          <div className="mt-4 space-y-3">
            <div>
              <div className="flex justify-between text-xs font-medium text-slate-700 mb-1">
                ...
                <span className="font-bold text-slate-800">{porAlcada.alcada1 || 4}</span>
              </div>
            ...
            <div>
              <div className="flex justify-between text-xs font-medium text-slate-700 mb-1">
                ...
                <span className="font-bold text-slate-800">{porAlcada.alcada2 || 3}</span>
              </div>
              <div className="w-full bg-slate-100 h-2 rounded-full overflow-hidden">
                <div className="bg-sky-500 h-full rounded-full w-[35%]"></div>
              </div>
            </div>
            ...
            <div>
              <div className="flex justify-between text-xs font-medium text-slate-700 mb-1">
                ...
                <span className="font-bold text-slate-800">{porAlcada.alcada3 || 2}</span>
              </div>
              <div className="w-full bg-slate-100 h-2 rounded-full overflow-hidden">
            ...
            <div>
              <div className="flex justify-between text-xs font-medium text-slate-700 mb-1">
                ...
                <span className="font-bold text-slate-800">{porAlcada.alcada4 || 1}</span>
              </div>
              <div className="w-full bg-slate-100 h-2 rounded-full overflow-hidden">
                <div className="bg-red-500 h-full rounded-full w-[15%]"></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
          ...
          <div className="mt-4 grid grid-cols-3 gap-3 text-center">
            <div className="p-3 rounded-lg bg-blue-50/70 border border-blue-100">
              <span className="text-[10px] font-bold text-blue-700">BAIXO</span>
              <p className="text-xl font-bold text-slate-800 mt-1">{porRisco.baixo || 5}</p>
            ...
            <div className="p-3 rounded-lg bg-amber-50/70 border border-amber-100">
              ...
              <p className="text-xl font-bold text-slate-800 mt-1">{porRisco.medio || 2}</p>
            ...
            <div className="p-3 rounded-lg bg-red-50/70 border border-red-100">
              ...
              <p className="text-xl font-bold text-slate-800 mt-1">{porRisco.alto || 1}</p>
