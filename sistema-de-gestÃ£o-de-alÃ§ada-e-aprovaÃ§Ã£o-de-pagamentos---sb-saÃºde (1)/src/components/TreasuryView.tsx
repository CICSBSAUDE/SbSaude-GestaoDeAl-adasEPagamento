        ...
        <div className="lg:col-span-7">
          {selectedReq ? (
            <div className="p-5 rounded-xl bg-white border border-slate-200 shadow-sm space-y-5">
              ...
              {/* Settlement summary */}
              <div className="p-4 rounded-lg bg-slate-50 border border-slate-200 grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs">
                <div>
              ...
              {selectedReq.status === 'PAGAMENTO_EFETUADO' ? (
                <div className="p-4 rounded-lg bg-emerald-50 border border-emerald-200 text-xs text-emerald-800 space-y-2">
                  <p className="font-bold text-emerald-800 flex items-center space-x-2">
                    <CheckCircle2 className="w-4 h-4 text-emerald-600" />
                    <span>Pagamento Liquidado e Comprovante Registrado</span>
                  </p>
                  <p>Comprovante / Autenticação: <strong className="font-mono text-slate-900">{selectedReq.registroPagamento?.numeroComprovante}</strong></p>
                  <p>Data do Pagamento: <strong className="text-slate-900">{selectedReq.registroPagamento?.dataPagamento}</strong></p>
                  <p>Responsável Tesouraria: <strong className="text-slate-900">{selectedReq.registroPagamento?.responsavelTesourariaNome}</strong></p>
                </div>
              ) : (
                <div className="space-y-4 text-xs">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        required
                        className="w-full px-3 py-2 rounded-lg bg-slate-50 border border-slate-200 text-slate-800 font-mono focus:outline-none focus:border-blue-600 focus:bg-white"
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-3 py-2 rounded-lg bg-slate-50 border border-slate-200 text-slate-800 placeholder-slate-400 focus:outline-none focus:border-blue-600 focus:bg-white"
                    />
                  </div>
                  ...
                  <div className="flex justify-end pt-2">
                    <button
                      ...
                      className="px-6 py-2.5 rounded-lg bg-blue-600 hover:bg-blue-700 text-white text-xs font-bold shadow-sm shadow-blue-200 transition flex items-center space-x-2"
                    >
