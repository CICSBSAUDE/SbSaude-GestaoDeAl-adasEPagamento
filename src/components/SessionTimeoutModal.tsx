...
export const SessionTimeoutModal: React.FC<SessionTimeoutModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[9999] flex items-center justify-center p-4">
      <div className="bg-white border border-slate-200 rounded-2xl max-w-md w-full p-6 sm:p-7 shadow-2xl space-y-5 animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="flex flex-col items-center text-center space-y-3">
          ...
          <div>
            <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-amber-100/80 text-amber-800 text-[10px] font-bold uppercase tracking-wider mb-1.5">
        ...
        <div className="bg-amber-50/60 rounded-xl p-4 border border-amber-200/70 flex flex-col items-center justify-center text-center space-y-1">
