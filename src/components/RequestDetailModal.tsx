                    ...
                    >
                      ...
                      <div>
                          ...
                          <div className="mb-1.5 pb-1 border-b border-slate-100">
                            ...
                            <div className="flex flex-wrap gap-1">
                              {etapa.cargosHabilitados.map((c: string, cIdx: number) => (
                                <span key={cIdx} className="px-1.5 py-0.2 rounded text-[9px] font-medium bg-slate-100 text-slate-700 border border-slate-200">
                                  {c}
                                </span>
                              ))}
                            </div>
                        ...
                        {etapa.semAprovadorCadastrado && !etapa.aprovadorRealNome ? (
                          <div className="mt-0.5 p-1.5 rounded bg-amber-100/70 border border-amber-200 text-amber-900 text-[11px]">
            ...
            {(isRequester || currentUser?.roles.includes('ADMINISTRADOR')) &&
              ...
              request.status !== 'CANCELADA' && (
                <button
                  ...
                  className="px-3 py-1.5 rounded-lg text-rose-600 hover:bg-rose-50 border border-rose-200 text-xs font-semibold transition flex items-center space-x-1.5"
                >
          ...
          <div className="fixed inset-0 bg-slate-900/60 z-60 flex items-center justify-center p-4">
            <div className="bg-white rounded-2xl border border-slate-200 max-w-md w-full p-6 shadow-2xl space-y-4">
              <div className="flex items-center space-x-3 text-rose-600">
                ...
                <div>
                  <h4 className="text-sm font-bold text-slate-800">Cancelar Solicitação {request.numero}</h4>
                  <p className="text-[11px] text-slate-500">Esta ação registrará o cancelamento na Trilha de Auditoria SGQ.</p>
                </div>
              </div>
