          ...
          <form onSubmit={handleSaveConfig} className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs">
            <div>
              ...
              <input
                ...
                className={`w-full px-3 py-2 rounded-lg border text-slate-800 ${isAdmin ? 'bg-slate-50 border-slate-200 focus:outline-none focus:border-blue-600 focus:bg-white' : 'bg-slate-100 border-slate-200 text-slate-500 cursor-not-allowed'}`}
              />
            </div>
