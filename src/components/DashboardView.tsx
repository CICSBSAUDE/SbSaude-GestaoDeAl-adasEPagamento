  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white dark:bg-slate-900 p-4 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col justify-between transition-colors">
          <div>
            <div className="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-tight mb-1">
          ...
          <div className="text-[10px] text-emerald-600 dark:text-emerald-400 font-semibold mt-2 flex items-center gap-1">
        ...
        <div className="bg-white dark:bg-slate-900 p-4 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col justify-between transition-colors">
          ...
          <div className="text-[10px] text-red-500 dark:text-red-400 font-semibold mt-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <section className="lg:col-span-2 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col overflow-hidden transition-colors">
          <div className="px-5 py-4 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between">
            <div>
              ...
              <p className="text-[11px] text-slate-500 dark:text-slate-400">
                Processos em andamento aguardando validação de alçada
              </p>
            </div>
            <button
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              <thead className="bg-slate-50 dark:bg-slate-800/80 sticky top-0 border-b border-slate-100 dark:border-slate-800">
                <tr>
                  <th className="px-5 py-3 text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase">
                    ID da Solicitação
                  </th>
                  <th className="px-5 py-3 text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase">
                    Processo / Favorecido
                  </th>
                  <th className="px-5 py-3 text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase text-right">
                    Valor
                  </th>
                  <th className="px-5 py-3 text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase text-center">
                    Risco
                  </th>
                  <th className="px-5 py-3 text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase">
                    Status Atual
                  ...
                  urgentRequests.map((r) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-5 py-3.5">
                          <div className="font-medium text-xs text-slate-800 dark:text-slate-200 truncate max-w-xs">
                            {r.processoNome}
                          </div>
                        ...
                        <td className="px-5 py-3.5 text-xs font-bold text-right text-slate-800 dark:text-slate-100 font-mono whitespace-nowrap">
        ...
        <aside className="flex flex-col gap-6">
          ...
          {/* Action Box */}
          <div className="bg-white dark:bg-slate-900 p-5 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col gap-4 transition-colors">
            <h3 className="font-bold text-sm text-slate-800 dark:text-slate-100">Ação Rápida</h3>
            <div className="flex flex-col gap-2.5">
              <button
                onClick={() => onNavigateTab('MINHA_FILA')}
                className="w-full bg-blue-600 hover:bg-blue-700 text-white py-2.5 rounded-lg text-xs font-bold shadow-md shadow-blue-600/20 active:scale-95 transition-all flex items-center justify-center gap-2 cursor-pointer"
              >
          ...
          <div className="bg-white dark:bg-slate-900 p-5 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col transition-colors">
            <div className="flex items-center justify-between mb-4">
              <h3 className="font-bold text-sm text-slate-800 dark:text-slate-100">
                Monitoramento de Tetos Orçamentários
              </h3>
              <span className="text-[10px] text-slate-400 dark:text-slate-500 font-mono">Mensal</span>
            </div>

            <div className="flex flex-col gap-4">
              <div className="space-y-1">
                <div className="flex justify-between text-[11px] font-bold text-slate-600 dark:text-slate-300 uppercase tracking-tight">
                ...
                <div className="text-[10px] text-slate-400 dark:text-slate-500">R$ 0 / R$ 500k</div>
              </div>
              ...
              <div className="space-y-1">
                ...
                <div className="text-[10px] text-slate-400 dark:text-slate-500">R$ 0 / R$ 20k</div>
              </div>
              ...
              <div className="bg-amber-50 dark:bg-amber-950/30 p-3 rounded-lg border border-amber-200 dark:border-amber-800/50 mt-1">
                <div className="text-[10px] font-bold text-amber-800 dark:text-amber-300 uppercase mb-0.5 flex items-center gap-1">
                  <AlertTriangle className="w-3.5 h-3.5 text-amber-600 dark:text-amber-400 shrink-0" />
                  <span>Alerta de Fracionamento de Compras (Item 7.2)</span>
                </div>
                <div className="text-[11px] text-amber-700 dark:text-amber-400/90 leading-tight">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-slate-900 p-5 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm transition-colors">
          <div className="flex items-center justify-between pb-3 border-b border-slate-100 dark:border-slate-800">
            <h3 className="text-xs font-bold text-slate-800 dark:text-slate-100 flex items-center gap-2 uppercase tracking-wide">
              <Layers className="w-4 h-4 text-red-600 dark:text-red-500" />
              <span>Enquadramento por Alçada Máxima Requerida</span>
            </h3>
            <span className="text-[10px] text-slate-400 dark:text-slate-500 font-mono">Governança</span>
          </div>
          ...
          <div className="mt-4 space-y-3">
            <div>
              <div className="flex justify-between text-xs font-medium text-slate-700 dark:text-slate-300 mb-1">
                ...
                <span className="font-bold text-slate-800 dark:text-slate-100">{porAlcada.alcada1 ?? 0}</span>
              </div>
            ...
            <div>
              <div className="flex justify-between text-xs font-medium text-slate-700 dark:text-slate-300 mb-1">
                ...
                <span className="font-bold text-slate-800 dark:text-slate-100">{porAlcada.alcada2 ?? 0}</span>
              </div>
              <div className="w-full bg-slate-100 dark:bg-slate-800 h-2 rounded-full overflow-hidden">
            ...
            <div>
              <div className="flex justify-between text-xs font-medium text-slate-700 dark:text-slate-300 mb-1">
                ...
                <span className="font-bold text-slate-800 dark:text-slate-100">{porAlcada.alcada3 ?? 0}</span>
              </div>
              <div className="w-full bg-slate-100 dark:bg-slate-800 h-2 rounded-full overflow-hidden">
            ...
            <div>
              <div className="flex justify-between text-xs font-medium text-slate-700 dark:text-slate-300 mb-1">
                ...
                <span className="font-bold text-slate-800 dark:text-slate-100">{porAlcada.alcada4 ?? 0}</span>
              </div>
              <div className="w-full bg-slate-100 dark:bg-slate-800 h-2 rounded-full overflow-hidden">
        ...
        <div className="bg-white dark:bg-slate-900 p-5 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm transition-colors">
          <div className="flex items-center justify-between pb-3 border-b border-slate-100 dark:border-slate-800">
            ...
            <span className="text-[10px] text-slate-400 dark:text-slate-500 font-mono">RN ANS nº 518</span>
          </div>

          <div className="mt-4 grid grid-cols-3 gap-3 text-center">
            <div className="p-3 rounded-lg bg-slate-50 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700">
              <span className="text-[10px] font-bold text-slate-700 dark:text-slate-300">BAIXO</span>
              <p className="text-xl font-bold text-slate-800 dark:text-slate-100 mt-1">{porRisco.baixo ?? 0}</p>
              <p className="text-[9px] text-slate-500 dark:text-slate-400 mt-0.5">Rotina operacional</p>
            </div>

            <div className="p-3 rounded-lg bg-amber-50/70 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800/50">
              <span className="text-[10px] font-bold text-amber-700 dark:text-amber-400">MÉDIO</span>
              <p className="text-xl font-bold text-slate-800 dark:text-slate-100 mt-1">{porRisco.medio ?? 0}</p>
              <p className="text-[9px] text-slate-500 dark:text-slate-400 mt-0.5">Impacto tático</p>
            </div>

            <div className="p-3 rounded-lg bg-red-50/70 dark:bg-red-950/30 border border-red-200 dark:border-red-800/50">
              <span className="text-[10px] font-bold text-red-600 dark:text-red-400">ALTO</span>
              <p className="text-xl font-bold text-slate-800 dark:text-slate-100 mt-1">{porRisco.alto ?? 0}</p>
              <p className="text-[9px] text-slate-500 dark:text-slate-400 mt-0.5">OPME / ANS / Liminares</p>
            </div>
          </div>

          <div className="mt-4 p-2.5 rounded-lg bg-slate-50 dark:bg-slate-800/80 text-[11px] text-slate-600 dark:text-slate-300 space-y-0.5 border border-slate-200/60 dark:border-slate-700/60">
            <p className="font-semibold text-slate-700 dark:text-slate-200">Elevação de Alçada Obrigatória:</p>
